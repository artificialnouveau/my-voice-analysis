...
def mysptotal(m,p):
    ...
    try:
        ...
        print(dataset.T)
        number_of_syllables=z5[0,:][0]
        number_of_pauses=z5[1,:][0]
        rate_of_speech=z5[2,:][0]
        articulation_rate=z5[3,:][0]
        speaking_duration=z5[4,:][0]
        original_duration=z5[5,:][0]
        balance=z5[6,:][0]
        f0_mean=z5[7,:][0]
        f0_std=z5[8,:][0]
        f0_median=z5[9,:][0]
